...
def create_collection(payload: CollectionCreate, db: Session = Depends(get_db)):
    ...
    Args:
        payload: CollectionCreate schema with collection name
        db: Database session dependency
        
    Returns:
        CollectionOut: Created collection object
    """
...
def list_collections(db: Session = Depends(get_db)):
    ...
    Returns:
        list[CollectionOut]: List of collection objects
    """
...
def get_collection(collection_id: uuid.UUID, db: Session = Depends(get_db)):
    ...
    Returns:
        CollectionOut: Collection object
...
def update_collection(
    ...
    Args:
        collection_id: UUID of the collection
        payload: CollectionCreate schema with new name
        db: Database session dependency
        
    Returns:
        CollectionOut: Updated collection object
